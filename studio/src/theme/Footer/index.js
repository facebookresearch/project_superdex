      ...
      <div className={styles.inner}>
        <div className={styles.columns}>
          <div className={styles.brandCol}>
            <div className={styles.brandName}>SuperDex Studio</div>
            <p className={styles.brandDesc}>
              The GUI authoring studio for SuperDex — import, mesh, edit, and
              simulate bots, prefabs, and scenes. Built by Meta Reality Labs
              Research.
            </p>
          </div>
