...
// Links map to this site's own tabs.
const QUICK_LINKS = [
  {label: 'Docs', to: '/docs/overview/'},
  {label: 'SuperDex Gym', to: '/docs/superdex_gym/intro/'},
];
      ...
      <div className={styles.inner}>
        <div className={styles.columns}>
          <div className={styles.brandCol}>
            <div className={styles.brandName}>SuperDex Lab</div>
            <p className={styles.brandDesc}>
              The research and experimentation hub for SuperDex — RL
              environments, training, and benchmarking. Built by Meta Reality
              Labs Research.
            </p>
          </div>
