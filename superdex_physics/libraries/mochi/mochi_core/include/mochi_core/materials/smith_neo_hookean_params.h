...
/**
 * @brief Parameters for the stable Neo-Hookean hyperelastic material model by Smith et al. (2018).
 *
 ...
 * @see SoftMaterialType::NeoHookean
 */
struct SmithNeoHookeanMaterialParams {
  ...
  MOCHI_STRUCT_BEGIN(mochi::SmithNeoHookeanMaterialParams)
...
namespace materials {
// Neo-Hookean (Smith) has an isotropic reference tangent by construction.
template <>
inline constexpr bool kIsotropicReferenceStiffness<SmithNeoHookeanMaterialParams> = true;
} // namespace materials
