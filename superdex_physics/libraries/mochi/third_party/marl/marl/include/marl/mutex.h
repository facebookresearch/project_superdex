...
class CAPABILITY("mutex") mutex {
 public:
  ...
  // [META] Support for TSA (thread safety analysis) requirements like "REQUIRES(!my_mutex)".
  // See <marl/tsa.h> for more details.
#if MARL_HAS_TSA
  MARL_NO_EXPORT inline const mutex& operator!() const {
    return *this;
  }
#endif
