...
// Prefer __attribute__((unused)) over [[maybe_unused]] because it can be
// placed either before or after the type in declarations.
#define UTILS_UNUSED __attribute__((unused))
#define UTILS_UNUSED_IN_RELEASE __attribute__((unused))
#elif __has_attribute(maybe_unused) || (defined(_MSC_VER) && _MSC_VER >= 1911)
