...
// Links map to this site's own tabs (API Reference & Integrations are
// intentionally not part of this site).
const QUICK_LINKS = [
      ...
      <div className={styles.inner}>
        <div className={styles.columns}>
          <div className={styles.brandCol}>
            <div className={styles.brandName}>SuperDex Robotics</div>
            <p className={styles.brandDesc}>
              Define, compose, and simulate robots on the SuperDex Physics engine. Built by Meta Reality
              Labs Research.
            </p>
          </div>
