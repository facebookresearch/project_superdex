...
const siteBaseUrl = isPublicBuild ? `${projectBaseUrl}robotics/` : '/';
...
(module.exports = {
  ...
  tagline:
    'Define, compose, and simulate robots — bots, arms, hands, and sensors — ' +
    'on the SuperDex Physics engine.',
  url: siteUrl,
  baseUrl: siteBaseUrl,
  onBrokenLinks: 'throw',
  trailingSlash: true,
